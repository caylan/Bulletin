...
DATABASES = {
    'default': {
        ...
        'NAME': './prototype.db',        # Or path to database file if using sqlite3.
...
SECRET_KEY = 'dbkeaqju-7jh&amp;dsk918h^wzm$h5ei6z12o$ayhsqg-h4@5o(qa'
...
STATIC_URL = 'http://bulletinapp.s3-website-us-east-1.amazonaws.com/'
